...
<div class="super_container">
							...
							<ul class="top_nav_menu">
								...
								<li class="account">
									...
									<ul class="account_selection">
										<li><a href="/user/profile"><i class="fa fa-user-plus" aria-hidden="true"></i>Profile</a></li>
	...
	<!-- Slider -->
	<div class="main_slider" style="background-image:url(/templates/assets/images/slider_1.jpg)">
	...
	<div class="banner">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(/templates/assets/images/banner_1.jpg)">
						<div class="banner_category">
							<a href="/home/category/women#category">women's</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(/templates/assets/images/banner_2.jpg)">
						<div class="banner_category">
							<a href="/home/category/accessories#category">accessories's</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(/templates/assets/images/banner_3.jpg)">
						<div class="banner_category">
							<a href="/home/category/men#category">men's</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div id="category" class="col text-center">
					...
					<form class="form-inline my-2 my-lg-0" id="search-tag" action="/home/search#search-tag" method="POST" style="margin-right: 75px;margin-left: 400px;">
			...
			<div class="row">
				<div class="col">
					<div id="container" class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
						<!-- Product  -->
						<script>
							var product=``  
						</script>
								...
								<div class="product-item {{ product['category'] }}">
									<div class="product discount product_filter">
										<div class="product_image">
											<img src="/templates/assets/{{ product['image'] }}" alt="">
										</div>
						...
						{% endfor %}
						<script>document.getElementById('container').innerHTML = product</script>
					</div>
				</div>
			</div>
			...
			<div class="row align-items-center">
				<div class="col-lg-6">
					<div class="deal_ofthe_week_img">
						<img src="/templates/assets/images/deal_ofthe_week.png" alt="">
					</div>
				</div>
						...
						<div class="owl-carousel owl-theme product_slider">
							...
							<div class="owl-item product_slider_item">
								<div class="product-item">
									<div class="product discount">
										<div class="product_image">
											<img src="/templates/assets/images/product_1.png" alt="">
										</div>
										<div class="favorite favorite_left"></div>
										<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-$20</span></div>
										<div class="product_info">
							...
							<div class="owl-item product_slider_item">
								<div class="product-item women">
									<div class="product">
										<div class="product_image">
											<img src="/templates/assets/images/product_2.png" alt="">
										</div>
							...
							<div class="owl-item product_slider_item">
								<div class="product-item women">
									<div class="product">
										<div class="product_image">
											<img src="/templates/assets/images/product_3.png" alt="">
										</div>
										<div class="favorite"></div>
										<div class="product_info">
							...
							<div class="owl-item product_slider_item">
								<div class="product-item accessories">
									<div class="product">
										<div class="product_image">
											<img src="/templates/assets/images/product_4.png" alt="">
										</div>
							...
							<div class="owl-item product_slider_item">
								<div class="product-item women men">
									<div class="product">
										<div class="product_image">
											<img src="/templates/assets/images/product_5.png" alt="">
										</div>
										<div class="favorite"></div>
										<div class="product_info">
							...
							<div class="owl-item product_slider_item">
								<div class="product-item accessories">
									<div class="product discount">
										<div class="product_image">
											<img src="/templates/assets/images/product_6.png" alt="">
										</div>
										<div class="favorite favorite_left"></div>
										<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-$20</span></div>
										<div class="product_info">
							...
							<div class="owl-item product_slider_item">
								<div class="product-item women">
									<div class="product">
										<div class="product_image">
											<img src="/templates/assets/images/product_7.png" alt="">
										</div>
										<div class="favorite"></div>
										<div class="product_info">
											<h6 class="product_name"><a href="single.html">Samsung CF591 Series Curved 27-Inch FHD Monitor</a></h6>
							...
							<div class="owl-item product_slider_item">
								<div class="product-item accessories">
									<div class="product">
										<div class="product_image">
											<img src="/templates/assets/images/product_8.png" alt="">
										</div>
										<div class="favorite"></div>
										<div class="product_info">
											<h6 class="product_name"><a href="single.html">Blue Yeti USB Microphone Blackout Edition</a></h6>
							...
							<div class="owl-item product_slider_item">
								<div class="product-item men">
									<div class="product">
										<div class="product_image">
											<img src="/templates/assets/images/product_9.png" alt="">
										</div>
										<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>sale</span></div>
										<div class="favorite favorite_left"></div>
										<div class="product_info">
							...
							<div class="owl-item product_slider_item">
								<div class="product-item men">
									<div class="product">
										<div class="product_image">
											<img src="/templates/assets/images/product_10.png" alt="">
										</div>
										<div class="favorite"></div>
										<div class="product_info">
											<h6 class="product_name"><a href="single.html">Pryma Headphones, Rose Gold & Grey</a></h6>
		...
		<div class="container">
			...
			<div class="row blogs_container">
				<div class="col-lg-4 blog_item_col">
					<div class="blog_item">
						<div class="blog_background" style="background-image:url(/templates/assets/images/blog_1.jpg)"></div>
				...
				<div class="col-lg-4 blog_item_col">
					<div class="blog_item">
						<div class="blog_background" style="background-image:url(/templates/assets/images/blog_2.jpg)"></div>
						<div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
							<h4 class="blog_title">Here are the trends I see coming this fall</h4>
							<span class="blog_meta">by admin | dec 01, 2017</span>
							<a class="blog_more" href="#">Read more</a>
				...
				<div class="col-lg-4 blog_item_col">
					<div class="blog_item">
						<div class="blog_background" style="background-image:url(/templates/assets/images/blog_3.jpg)"></div>
						<div class="blog_content d-flex flex-column align-items-center justify-content-center text-center">
							<h4 class="blog_title">Here are the trends I see coming this fall</h4>
							<span class="blog_meta">by admin | dec 01, 2017</span>
							<a class="blog_more" href="#">Read more</a>
...
<script src="/templates/assets/styles/bootstrap4/popper.js"></script>
<script src="/templates/assets/styles/bootstrap4/bootstrap.min.js"></script>
<script src="/templates/assets/plugins/Isotope/isotope.pkgd.min.js"></script>
<script src="/templates/assets/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="/templates/assets/plugins/easing/easing.js"></script>
